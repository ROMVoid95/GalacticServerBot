...
import static com.readonlydev.util.EmoteReference.BLUE_SMALL_MARKER;
...
public class StringUtils {
	...
	/**
	 * Fixes the direction of the rendering of the text inside `inline codeblocks`
	 * to be always left to right.
	 *
	 * @param src Source string.
	 *
	 * @return String with appropriate unicode direction modifier characters around
	 *         code blocks.
	 */
	@Nonnull
	@CheckReturnValue
